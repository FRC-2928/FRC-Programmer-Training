...
# Robot Control
The programming team is primarily tasked with controlling the robot.  On the competitioin robot the control software runs on the [RoboRIO](https://docs.wpilib.org/en/stable/docs/software/roborio-info/roborio-introduction.html) that is a controller made specifically for FRC.
...
## References 
- FRC Documentation [RoboRIO](https://docs.wpilib.org/en/stable/docs/software/roborio-info/roborio-introduction.html)
